...
interface OrigenMasterDataPageProps {
  config: MasterDataConfig;
}

export function OrigenMasterDataPage({ config }: OrigenMasterDataPageProps) {
  ...
  const {
    ...
    paises,
    caeAduanas,
  } = useOrigenMasterData(config.apiEndpoint, {
  ...
  const dynamicConfig = {
    ...
    fields: config.fields.map(field => {
      ...
      if (field.name === 'idCaeAduana') {
        return { ...field, options: caeAduanas };
      }
      return field;
    }),
  };
